...
- คำสั่งที่ 1 ถูกดึงมาวางที่ bus เรียง word ใหม่ จากขวาไปซ้าย แล้วแปลคำสั่ง จากนั้นนำข้อมูลจาก x0 และ ข้อมูล 20 มาบวกกัน แล้วนำผลลัพธ์ไปใส่ใน x1 จบคำสั่งที่ 1  
...
อธิบายคำสั่งที่ 5 นำคำสั่ง address 10 มาเรียง word  ใหม่ แล้วแปลคำสั่ง จะเป็นการนำข้อมูล x2 มาบวกกับ 0 แล้วนำผลลัพธ์มาชี้ในหน่วยความจำ แล้วนำ x3 (เลข 53) มาไว้ที่หน่วยความจำ และจะไปที่ data ซึ่งจะมีตัวอักษร S พิมพ์ใหญ่แสดงขึ้นมา  
