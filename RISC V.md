...
- คำสั่งที่ 5 นำคำสั่ง address 10 มาเรียง word  ใหม่ แล้วแปลคำสั่ง จะเป็นการนำข้อมูล x2 มาบวกกับ 0 แล้วนำผลลัพธ์มาชี้ในหน่วยความจำ แล้วนำ x3 (เลข 53) มาไว้ที่หน่วยความจำ และจะไปที่ data ซึ่งจะมีตัวอักษร S พิมพ์ใหญ่แสดงขึ้นมา *จบการทำงาน loop ที่ 1 ต่อมาจะเป็นการทำซ้ำแบบเดิมใน loop ที่ 2 เพื่อแสดงตัวอักษร T พิมพ์ใหญ่*  
